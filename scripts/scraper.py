...
def elabora_spesa(atto: dict) -> dict:
    ...
    return {
        ...
        "n_beneficiari": dati.get("n_beneficiari", 1),
        "beneficiari_dettaglio": dati.get("beneficiari_dettaglio"),
        "importo_euro": dati["importo_euro"],
        "importo_testuale": dati.get("importo_testuale"),
        "importo_e_pluriennale": dati.get("importo_e_pluriennale", False),
        "durata_anni": dati.get("durata_anni"),
